...
print(f"ANTHROPIC loaded: {ANTHROPIC_API_KEY is not None}")
...
class ReadingComprehensionGenerator:
    """Main class for generating reading comprehension questions"""
    ...
    def main_workflow(self, input_source: str):
        ...
        print(f"🤖 Using Claude 4 Sonnet for all generation tasks")
        ...
        for url_index, url in enumerate(urls, 1):
            ...
            for grade in [5, 6, 7, 8, 9]:
                ...
                for passage_num in range(3):  # Try to get 3 passages per URL per grade
                    ...
                    # STEP 3: Extract passage using Claude
                    print(f"   📤 STEP 3: Extracting passage with Claude 4...")
                    passage_data = self.extract_passage_with_claude(
                    ...
                    while question_attempts < MAX_QUESTION_ATTEMPTS and not questions_generated:
                        ...
                        # Generate all questions with Claude
                        print(f"      🤖 Generating all questions with Claude 4...")
                        all_questions = self.generate_all_questions_claude(
    ...
    def extract_passage_with_claude(self, content: str, grade: int, 
                                   min_words: int, max_words: int, 
                                   passage_num: int, url: str) -> Optional[Dict]:
        """Extract appropriate passage using Claude 4"""
...
"""
        ...
        try:
            self.statistics['claude_calls'] += 1
            ...
            passage_data = json.loads(response_text.strip())
    ...
    def generate_all_questions_claude(self, passage: str, grade: int) -> Optional[List[Dict]]:
        """Generate all comprehension questions using Claude 4"""
...
Generate exactly 4 comprehension questions:"""
        ...
        try:
            ...
            if 'questions' in content and len(content['questions']) == 4:
                ...
                print("      ⚠️ Invalid question format from Claude")
                return None
    ...
    def print_statistics(self):
        ...
        print(f"   Claude API calls: {self.statistics['claude_calls']}")
