...
export const onAuthChange = (callback) => {
  authListenerCount++;
  console.log(`Firebase: Setting up auth state listener (active: ${authListenerCount})`);
  ...
  // Return wrapped unsubscribe that decrements counter
  return () => {
    authListenerCount--;
    console.log(`Firebase: Removing auth state listener (remaining: ${authListenerCount})`);
    unsubscribe();
  };
};