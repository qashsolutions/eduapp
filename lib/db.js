...
// This is safe because we're validating Firebase auth before any DB operations
...
export const createUser = async (email, userId, role = 'student', grade = 8) => {
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert([{
        ...
        email: email,
        role: role,
        grade: role === 'student' ? grade : null, // Only set grade for students
